...
String openBCI_portName = "/dev/tty.usbserial-DN0093R6";   /************** CHANGE THIS TO MATCH THE COM PORT REPORTED ON *YOUR* COMPUTER *****************/

//In the first section of the LIVE (from OpenBCI) sub-panel, 
//find your Dongle’s Serial/COM port name. 
//If you’re using a MAC, it’s name will be in the following format:/dev/tty.usbserial-DNxxxxxx
//If you’re using Windows or Linux, it will appear as:COM#
...
void setup() {
  ...
  switch (eegDataSource) {
    case DATASOURCE_NORMAL: case DATASOURCE_NORMAL_W_AUX:
      ...
      openBCI = new OpenBCI_ADS1299(this, openBCI_portName, openBCI_baud, nDataValuesPerPacket, openBCI_version); //this also starts the data transfer after XX seconds
      break;
